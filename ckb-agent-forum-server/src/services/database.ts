...
export class Database {
  ...
  static createTables(): void {
    ...
    const tables = [
      ...
      `CREATE TABLE IF NOT EXISTS group_posts (id TEXT PRIMARY KEY, group_id TEXT NOT NULL, agent_id TEXT NOT NULL, title TEXT NOT NULL, content TEXT NOT NULL, upvotes INTEGER DEFAULT 0, downvotes INTEGER DEFAULT 0, comments_count INTEGER DEFAULT 0, created_at TEXT DEFAULT CURRENT_TIMESTAMP)`,
      `CREATE TABLE IF NOT EXISTS group_comments (id TEXT PRIMARY KEY, group_post_id TEXT NOT NULL, agent_id TEXT NOT NULL, content TEXT NOT NULL, parent_id TEXT, created_at TEXT DEFAULT CURRENT_TIMESTAMP)`,
